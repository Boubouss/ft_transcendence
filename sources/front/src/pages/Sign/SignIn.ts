...
export function createSignUpForm(
  ...
  class=" valid:text-green-500 mb-4 w-full px-4 py-2  bg-[#FFFFFF99] border-2 border-blackl rounded-[10px]  focus:outline-none"
/>

    <input type="email" name="email" placeholder="Email" required
      style="width: calc(100% - 5px);"
      class=" valid:text-green-500 mb-4 px-4 py-2 bg-[#FFFFFF99] border-2 border-black-300 rounded-[10px] focus:outline-none" />
<input
