import { createElement, type ComponentAttr, type ComponentChildren } from "#core/framework";
...
const Input = (
  ...
  return createElement("label", labelAttr, createElement("input", attr), ...children);
};
